...
// Will need to change if compiled without c++17 standard
#ifdef GNU_COMPILED
...
private:
    ...
    {
        vkWaitForFences(
            device, 1, &inFlightFences[currentFrame], VK_TRUE,
    ...
    std::vector<const char*> getRequiredExtensions()
    {
        ...
        // glfwGetRequiredInstanceExtensions() should return the platform-specific extensions
        // we need to create a vulkan window across different platforms
